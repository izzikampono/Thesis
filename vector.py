...
class AlphaVector:
    def __init__(self,DR,vector1,vector2,belief_id, sota=False):
        self.DR = DR
        self.sota = sota
...
class BetaVector:
    ...
    def get_alpha_vector(self,belief_id, game_type, DR, sota=False):
        ...
        return AlphaVector(DR,vectors[0],vectors[1],belief_id, sota)
