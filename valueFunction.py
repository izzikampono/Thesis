...
class ValueFunction:
    ...
    def solve(self,belief_id,game_type,timestep):
        ...
        # construct betas using alpha mappings of (belief,action,observation) -> maximum alpha
        ...
        #printing
        if np.abs(max_plane_leader_value-tabular_leader_value)>0.001 or np.abs(max_plane_alpha.get_value(belief)[0]-tabular_alpha.get_value(belief)[0])>0.001 :
